...
namespace Benchmarks.Trace
{
    ...
    public class SpanBenchmark
    {
        ...
        [Params(TagsTypes.Dictionary, TagsTypes.SplitDictionary)]
        ...
        {
            if (TagsType == TagsTypes.Dictionary)
            {
                return new TagsDictionary();
            }
            else if (TagsType == TagsTypes.SplitDictionary)
            {
                return new TagsSeparateDictionary();
            }
